...
import 'package:selectable/views/admin/restaurants/details/components/availability.dart';
...
class _ADetailsState extends State<ADetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ARestaurantProvider>(
      builder: (context, restaurantProvider, child) => FutureBuilder(
        future: restFuture,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          const Expanded(
                              child: SmallHeading(text: "Slots Availability")),
                          TableAvailability(restaurant: restaurant)
                        ],
                      ),
                    ],
                  ),
